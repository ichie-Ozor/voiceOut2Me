...
const OurSpecialFeature = () => {
  ...
  return (
    <div className="w-[92vw] ml-auto lg:w-[95vw] xl:w-[92vw]">
      <div className=" header-wrapper w-[15rem] md:w-[20.688rem] md:h-[5.813rem] bg-[#695E93BF] flex flex-col justify-center items-center gap-1 mt-[5rem] lg:mr-0 md:ml-[45%] lg:ml-[53%]">
      ...
      <section className=" flex flex-col-reverse md:flex lg:flex-row gap-4">
        <div className="w-[92%] grid gap-5 grid-cols-1 md:w-[90%] lg:w-[60%] xl:w-[52%] md:grid md:grid-cols-2 md:gap-[2rem] lg:gap-[2rem] overflow-hidden ml-0">
        ...
        <section className="w-[48%] md:w-[80%] lg:w-[38%] p-4 mt-[2rem]">
          <p
            className=" w-[16rem] text-center md:text-left md:w-[30rem] lg:w-[19.625rem]"
            data-aos="fade-up"
