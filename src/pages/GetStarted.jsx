      ...
      <div className="w-full  relative">
        ...
        <main className="w-full flex flex-col items-center gap-10">
          ...
          <section className="w-full flex flex-col lg:w-[60%] gap-2">
            ...
            <Link to={"/logincounselor"} className="  py-4 w-[80%] text-white bg-[#695E93] rounded-[20px] font-bold lg:text-[32px] text-center transition-all hover:opacity-70">Are you a couselor?</Link>
            ...
            <Link to={"/home"} className="text-[#694976] border-b-2 lg:w-[8.438rem] border-[#694976] py-2 hover:opacity-60 lg:ml-[-60%] mt-10">Back to Homepage</Link>
            </div>
          </section>
        </main>
