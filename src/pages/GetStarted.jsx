      ...
      <div className="w-full  relative">
        ...
        <main className="w-full flex flex-col items-center gap-10">
          <section className="  flex flex-col gap-5 lg:gap-8 justify-center items-center lg:w-[40%] ">
            ...
            <p className=" w-[18.5rem] sm:w-[30rem] text-justify text-sm lg:w-[40rem] lg:text-lg sm:text-center">
          ...
          <section className="w-full flex flex-col lg:w-[60%] gap-2">
            ...
            <Link to={"/"} className="text-[#694976] border-b-2 w-[8.438rem] border-[#694976] py-2 hover:opacity-60 lg:ml-[-60%] mt-10">Back to Homepage</Link>
            </div>
          </section>
        </main>
