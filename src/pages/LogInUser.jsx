      ...
      <div className="w-full h-full relative font-Lato">
        ...
        <main className="flex flex-col lg:flex-row ">
          ...
          <section className="w-full lg:w-[50%] ml-[0.3rem] md:ml-[1rem] lg:ml-0">
            ...
            <p className="text-[#414041] mt-[2rem] mb-[5rem] lg:my-[1rem] lg:mt-[5rem] ml-[8%] lg:ml-0">Don’t have an account?<span className="text-[#938AB4]"><Link to={"/signupuser"}>Create Account</Link></span> </p>
          </section>
        </main>
      </div>
    </>
